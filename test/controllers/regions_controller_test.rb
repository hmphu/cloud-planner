...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference('Region.count') do
      post regions_url, params: { region: { name: @region.name, provider_id: @region.provider_id } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { name: @region.name, provider_id: @region.provider_id } }
